							    ...
							    <table class="table table-striped" align="center">
								  <thead>
								    <tr>
								      ...
								      <th scope="col" style="text-align: center;width:28%">Item Name</th>
								      <th scope="col" style="text-align: center;width:18%">Remark</th>
								      <th scope="col" style="text-align: center;width:10%">Stock</th>
								      <th scope="col" style="text-align: center;width:10%">Quantity</th>
								      <th scope="col" style="text-align: center;width:9%">Unit</th>
