		...
		<div class="row" style="margin-top: 5%">
			<div class="col-md-6">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    <h5 class="card-title">Get Customer Reports</h5>
				    <form id="customer_reports" onsubmit="return false">
				    	<div class="row">
				    		<div class="col-md-8">
				    			<div class="form-group">
						    		<select class="form-control" id="customer_name_for_reports" name="customer_name_for_reports">
			...
			<div class="col-md-6">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    <h5 class="card-title">Get Supplier Report</h5>
				    <form id="supplier_reports" onsubmit="return false">
				    	<div class="row">
				    		<div class="col-md-8">
				    			<div class="form-group">
						    		<select class="form-control" id="supplier_name_for_reports" name="supplier_name_for_reports">
				    		...
				    		<div class="col-md-4">
				    			<div class="form-group">
						    		<select class="form-control" id="report_type_supplier" name="report_type_supplier">
						    			<option value="Due">Pending</option>
						    			<option value="Paid">Paid</option>
						    			<option value="All">All</option>
						    		</select>
				    	...
				    	<div class="row">
				    		<div class="col-md-6">
				    			<div class="form-group">
				    				<label for="start_date_supplier_reports">From</label>
						    		<input type="date" name="start_date_supplier_reports" id="start_date_supplier_reports" class="form-control" required>
						    	</div>
				    		</div>
				    		<div class="col-md-6">
				    			<div class="form-group">
				    				<label for="end_date_supplier_reports">To</label>
						    		<input type="date" name="end_date_supplier_reports" id="end_date_supplier_reports" class="form-control" required>
						    	</div>
				    		</div>
				    	</div>
				    	<center>
