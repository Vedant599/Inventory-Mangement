...
if(isset($_POST["getOrderItem"]))
{
	...
	<tr>
      ...
      <td>
      	<select name="qty_cat[]" class="form-control qty_cat">
      ...
      <td>
      	<input type="number" name="price[]" class="form-control price" step="0.001">
      </td>
      <td hidden="true">
...
if(isset($_POST["orderdate"]) AND isset($_POST["customername"]))
{
	...
	$ar_tqty = $_POST["tqty"];
	$ar_qty = $_POST["qty"];
	$ar_qty_cat = $_POST["qty_cat"];
	$ar_price = $_POST["price"];
	$ar_pro_name = $_POST["pro_name"];	

	$obj=new Manage();
	echo $obj->addInvoice($customername,$orderdate,$ar_tqty,$ar_qty,$ar_qty_cat,$ar_price,$ar_pro_name,$sub_total,$gst,$discount,$net_total,$paid,$due,$payment_type);
}
